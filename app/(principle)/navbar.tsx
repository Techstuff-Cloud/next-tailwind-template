...
const PrincipleNavbar = () => {
  ...
  return (
    <nav>
      <Link href={"/principle/library"} disabled={!hasViewLibraryPerms}>
        View Library
      </Link>

      <Link href={"/principle/student"} disabled={!hasViewStudentPerms}>
        View Students
      </Link>

      <Link href={"/principle/class"} disabled={!hasViewClassPerms}>
        View Class
      </Link>

      <Link href={"/principle/setting"} disabled={!hasViewSettingPerms}>
        View Setting
      </Link>

      <Link href={"/principle/teacher"} disabled={!hasViewTeacherPerms}>
        View Teacher
      </Link>
    </nav>
  );
