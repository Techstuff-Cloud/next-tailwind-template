...
const PrincipleTeacherPage = () => {
  const [hasAddTeacherPerms, hasEditTeacherPerms, hasDeleteTeacherPerms] = usePermissions([
  ...
  return (
    <div className='flex justify-end gap-3'>
      <Button
        ...
        className={!hasAddTeacherPerms ? 'cursor-not-allowed !pointer-events-auto' : ''}
      >
        Add Teacher
      </Button>
      ...
      <Button
        ...
        className={!hasEditTeacherPerms ? 'cursor-not-allowed !pointer-events-auto' : ''}
      >
        Edit Teacher
      </Button>
      ...
      <Button
        ...
        className={!hasDeleteTeacherPerms ? 'cursor-not-allowed !pointer-events-auto' : ''}
      >
        Delete Teacher
      </Button>
    </div>
