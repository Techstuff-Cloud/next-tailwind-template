...
const ManagementNavbar = () => {
  const [hasViewPrinciplePerms, hasViewStudentPerms, hasViewClassPerms, hasViewSettingPerms] = usePermissions([
  ...
  return (
    <nav>
      <Link
        href={'/management/principle'}
        disabled={!hasViewPrinciplePerms}
      >
        View Principles
      </Link>

      <Link
        href={'/management/student'}
