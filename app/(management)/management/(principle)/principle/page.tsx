...
const ManagementPrinciplePage = () => {
  const [hasAddPrinciplePerms, hasEditPrinciplePerms, hasDeletePrinciplePerms] =
    usePermissions([
  ...
  return (
    <div className="flex justify-end gap-3">
      <Button
        ...
        className={
          !hasAddPrinciplePerms ? "cursor-not-allowed !pointer-events-auto" : ""
        }
      >
        Add Principle
      </Button>
